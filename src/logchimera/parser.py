...
class LogParser:
    ...
    def outputResult(self, logClustL):
        ...
        #self.df_log.to_csv("structured.csv", index=False)
        ...
        #df_event.to_csv("templates.csv", index=False)
        # return self.df_log
...
parsing_setting = {
    "generic_dataset": {"log_format": "<Content>", "regex": [], "st": 0.7, "depth": 6},
}

def parse_log_lines(file_path):
    parsed_logs = parsing_logs(parsing_setting["generic_dataset"], "./", "./", file_path)
    print(parsed_logs)
    return parsed_logs